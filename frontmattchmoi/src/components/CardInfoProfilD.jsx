...
function CardInfoProfil({ userInfo }) {
  ...
  return (
    <div className="bg-[#1b1142] w-[400px] h-[440px] flex flex-col rounded-xl border-4 border-white relative">
      {imageUrl && (
        <div>
          <img src={imageUrl} alt="Profile"  className="object-cover w-[300px] h-[230px] bg-top rounded-lg shadow-xl"/>
        </div>
      )}
      <div className="p-4">
      ...
      <div className="flex text-sm text-white space-x-1 opacity-65">
